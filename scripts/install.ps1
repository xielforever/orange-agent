...
#
# Usage:
#   irm https://raw.githubusercontent.com/xielforever/orange-agent/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:xielforever/orange-agent.git"
$RepoUrlHttps = "https://github.com/xielforever/orange-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/xielforever/orange-agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/xielforever/orange-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
